...
export const Withdraw = () => {
  ...
  const handleWithdraw = async () => {
    ...
    const fundAssociatedTokenAddress2 = await createAssociatedTokenAccount(key, new PublicKey('DdzREMVFg6pa5825HBKVzeCrEi8EJiREfb8UrxSZB64w'), MPDA[0], transaction);
    const fundAssociatedTokenAddress3 = await createAssociatedTokenAccount(key, new PublicKey('DdzREMVFg6pa5825HBKVzeCrEi8EJiREfb8UrxSZB64w'), MPDA[0], transaction);
