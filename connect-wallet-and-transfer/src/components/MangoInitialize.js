...
import { adminAccount, connection, FUND_ACCOUNT_KEY, MANGO_PROGRAM_ID, RENT_PROGRAM_ID, programId, MANGO_PROGRAM_ID_V2, MANGO_GROUP_ACCOUNT } from '../utils/constants';
    ...
    //   const fundBaseTokenAccount = await findAssociatedTokenAddress(new PublicKey(fundPDA), new PublicKey(TEST_TOKENS['USDR'].mintAddress));
      ...
      dataLayout.encode(
        ...
        keys: [
            ...
            // TODO: MANGO_PROGRAM_ID, MANGO_GROUP_ACC, margin_account_acc
