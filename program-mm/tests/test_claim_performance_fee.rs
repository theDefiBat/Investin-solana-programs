...
use mm::{
    ...
    instruction:: {init_mm_fund, investor_deposit, process_deposit, investor_request_withdraw, process_withdraw, claim_performnace_fee},
};
...
async fn test_mm_fund() {
    ...
    let admin_usdc_vault = add_token_account(
        &mut test,
        admin.pubkey(),
        usdc_mint.pubkey,
        0,
